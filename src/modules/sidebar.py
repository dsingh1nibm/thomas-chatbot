...
class Sidebar:
    ...
    MODEL_OPTIONS = ["gpt-3.5-turbo", "gpt-4", "open-source"]
    ...
    @staticmethod
    def about():
        about = st.sidebar.expander("🧠 About Thomas ")
        sections = [
            "#### Thomas is an AI chatbot with a conversational memory, designed to allow users to discuss their data in a more intuitive way. 📄",
    ...
    def show_options(self):
        ...
        with st.sidebar.expander("🛠️ Thomas's Tools", expanded=False):
